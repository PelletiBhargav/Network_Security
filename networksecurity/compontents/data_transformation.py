...
from networksecurity.entity.arttifact_entity import DataTransformationArtifact,DataValidationArtifact
...
class DataTransformation:
    ...
    def initiate_data_transformation(self)->DataTransformationArtifact:
        ...
        try:
            ...
            preposser=self.get_data_transformer_object()
            preprocessor_object=preposser.fit(input_feature_test_df)
